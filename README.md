# Deploying Three Tier App

## Overview
This repository provides a step-by-step guide to deploying a Three-Tier Application, which includes the presentation tier (frontend), logic tier (backend), and data tier (database). This architecture ensures a scalable, maintainable, and secure application.
